...
*/	
	...
	return array(
		...
		'categories_not_shown' => 'Some Post have categories which will not be displayed.',
		...
		'category_no_sub_error' => '^q Post/s in this category have no sub-category - ^1set sub-category^2',
		'category_no_sub_to' => 'Move Post in ^ with no sub-category to:',
		'category_no_subs' => 'None',
		'category_none_error' => '^q Post/s currently have no category - ^1set category^2',
		'category_none_to' => 'Move Post with no category to:',
		...
		'delete_category_reassign' => 'Delete this category and reassign its Post to:',
		...
		'delete_hidden_note' => ' - all hidden Post, Comment and comments without dependents',
		...
		'hidden_answers_deleted' => 'Deleted ^1 of ^2 hidden Comments without dependents...',
		'hidden_comments_deleted' => 'Deleted ^1 of ^2 hidden comments...',
		'hidden_Media_deleted' => 'Deleted ^1 of ^2 hidden Post without dependents...',
		'hotness_factors' => 'Relative importance for Post hotness:',
		'hidden_title' => 'Hidden',
		'ip_address_pages' => 'IP address pages',
		'layout_title' => 'Layout',
		'link_name' => 'Text of link:',
		'link_new_window' => 'Open link in a new window',
		'link_url' => 'URL of link - absolute or relative to Post root:',
		'lists_title' => 'Lists',
		...
		'hnav_links_explanation' => 'Show header nav links:',
		'nav_qa_is_home' => ' (links to home page)',
		'neat_urls_note' => ' (requires "htaccess" file)',
		...
		'q2a_db_version' => 'Media database version:',
		'q2a_latest_version' => 'Latest version:',
		'q2a_version' => 'KingMedia version:',
		'question_lists' => 'Home Page',
		'question_pages' => 'Post Page',
		...
		'recalc_categories_recounting' => 'Recounting Post for ^1 of ^2 categories...',
		...
		'recalc_posts_count' => 'Getting total number of Post, Comments and comments...',
		...
		'recount_posts_as_recounted' => 'Recounted Comments and hotness for ^1 of ^2 posts...',
		'recount_posts_complete' => 'All posts were successfully recounted.',
		'recount_posts_note' => ' - the number of Comments, votes, flags and hotness for each post',
		...
		'refill_events_refilled' => 'Refilled for ^1 of ^2 Post...',
		'refill_events' => 'Refill event streams',
		'reindex_content' => 'Reindex content',
		'reindex_content_note' => ' - for searching and related Post suggestions',
		...
		'requires_q2a_version' => 'Disabled - requires KingMEDIA ^ or later',
		...
		'tags_not_shown' => 'Some Post have tags which will not be displayed.',
		'tags' => 'Tags',
		...
		'total_as' => 'Total Comments:',
		'total_cs' => 'Total replies:',
		'total_qs' => 'Total Post:',
		'unnamed_plugin' => 'Unnamed Plugin',
		'upgrade_db' => 'Your KingMEDIA database needs to be ^1upgraded^2 for this version.',
		...
		'version_requires_q2a' => '^1 requires Post ^2', 
		'version_latest_unknown' => 'latest unknown',
		'version_latest' => 'latest',
		'viewing_title' => 'Posting',
		...
		'save_view_button' => 'Save and Preview',
		'editusers_title' => 'Users',
		'manage' => 'Manage',
	);
