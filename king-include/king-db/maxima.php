...
/*
	...
	File: king-include/king-db-maxima.php
...
//	Maximum column sizes - any of these can be defined in king-config.php to override the defaults below,
//	but you need to do so before creating the database, otherwise it's too late.
	...
	@define('QA_DB_MAX_META_CONTENT_LENGTH', 18000);
