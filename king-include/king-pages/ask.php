...
if ($permiterror || qa_opt( 'disable_image' )) {
...
$images = '<div id="dropzone" class="dropzone king-poll-file"></div>';
...
if (qa_using_categories() && count($categories)) {
	...
	qa_array_insert($qa_content['form']['fields'], 'imgupload', array('category' => $field));
}
