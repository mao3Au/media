...
if (qa_clicked('doask')) {
    ...
    if (!qa_check_form_security_code('ask', qa_post_text('code'))) {
        ...
        if (empty($errors)) {
            ...
            if ($type == "dailymotion.com" || $type == "metacafe.com" || $type == "vine.co" || $type == "instagram.com" || $type == "vid.me" || $type == "drive.google.com" || $type == "open.spotify.com" || $type == "twitter.com" || $type == "xvideos.com" || $type == "rutube.ru") {
...
$qa_content['title'] = qa_lang_html(isset($followanswer) ? 'question/ask_follow_title' : 'main/home_video');
...
if (qa_opt('links_in_new_window')) {
    ...
    $vidupload .= '<li class="active"><a href="#vidurl" aria-controls="vidurl" class="king-vidurl" role="tab" data-toggle="tab"><i class="fas fa-link"></i></a></li>
                <li ><a href="#vidup" aria-controls="vidup" class="king-vidup" role="tab" data-toggle="tab"><i class="fas fa-cloud-upload-alt"></i></a></li>';
    $vidupload .= '</ul>';
}
