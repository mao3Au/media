...
/*
	...
	File: king-include/king-page-hot.php
...
//	Get list of hottest questions, allow per-category if QA_ALLOW_UNINDEXED_QUERIES set in king-config.php

	$categoryslugs=QA_ALLOW_UNINDEXED_QUERIES ? qa_request_parts(1) : null;
	$countslugs= isset($categoryslugs) ? count($categoryslugs) : '';
