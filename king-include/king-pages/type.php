...
*/
	...
	switch ($by) {
		case 'images':
			...
			break;
		case 'news':
				$sometitle=qa_lang_html('main/home_news');
				$nonetitle=qa_lang_html('main/home_news');
				$count=qa_opt('cache_unupaqcount');

			break;
		case 'poll':
				$sometitle=qa_lang_html('misc/king_poll');
				$nonetitle=qa_lang_html('misc/king_poll');
			break;
		case 'list':
				$sometitle=qa_lang_html('misc/king_list');
				$nonetitle=qa_lang_html('misc/king_list');
			break;
		case 'trivia':
				$sometitle=qa_lang_html('misc/king_list');
				$nonetitle=qa_lang_html('misc/king_list');
			break;
		case 'music':
				$sometitle=qa_lang_html('misc/king_music');
				$nonetitle=qa_lang_html('misc/king_music');
			break;
		default:
