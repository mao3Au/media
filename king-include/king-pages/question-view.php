...
/*
	...
	File: king-include/king-page-question-view.php
...
/*
	...
	post. This function is a key part of KINGMEDIA's logic and is ripe for overriding by plugins. Pass $post's $parentpost if
	...
	//	Extra value display
		...
		if (strlen($question['extra'] ?? '') && qa_opt('extra_field_active') && qa_opt('extra_field_display'))
			$q_view['extra']=array(
				...
				'content' => qa_sanitize_html(qa_block_words_replace($question['extra'], qa_get_block_words_preg())),
			);
