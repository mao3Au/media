...
//	Define the options to show (and some other visual stuff) based on request
	...
	switch ($adminsection) {
		...
		case 'membership':
			...
			$showoptions=array('enable_homepagelogin', 'login_back_url', 'login_logo_url', 'hlogin_desc', 'desc_color', '', 'enable_membership', 'currency', 'enable_stripe', 'stripe_pkey', 'stripe_skey', 'enable_paypal', 'paypal_email', 'paypal_sandbox', '', 'plan_1', 'plan_n_1', 'plan_t_1', 'plan_usd_1', 'plan_1_title', 'plan_1_desc', '', 'plan_2', 'plan_n_2', 'plan_t_2', 'plan_usd_2', 'plan_2_title', 'plan_2_desc', '', 'plan_3', 'plan_n_3', 'plan_t_3', 'plan_usd_3', 'plan_3_title', 'plan_3_desc', '', 'plan_4', 'plan_n_4', 'plan_t_4', 'plan_usd_4', 'plan_4_title', 'plan_4_desc', 'enable_m_msg', 'membership_msg');
		...
		case 'viewing':
			...
			array_push($showoptions, 'disable_image', 'disable_video', 'disable_news', 'disable_poll', 'disable_list', 'disable_trivia', 'disable_music', '', 'enable_amp', '', 'enable_aws', 'aws_key', 'aws_secret', 'aws_bucket', 'aws_region', 'enable_wasabi', 'wasabi_key', 'wasabi_secret', 'wasabi_bucket', 'wasabi_region', '', 'links_in_new_window', 'enable_music_upload', 'enable_nsfw', 'image_max_upload', 'image_max_file_count', 'video_max_upload', 'video_ffmpeg', 'fb_user_token', 'watermark_default_show', 'watermark_position', '', 'sort_answers_by', 'page_size_q_as');
		...
		if (empty($optionname)) {
			...
			switch ($optionname) { // special treatment for certain options
				...
				case 'king_grids';
					...
					$rawoptions=array( 'grids-1', 'grids-2', 'grids-3', 'grids-4', 'grids-5', 'grids-6', 'grids-7', 'grids-hide' );
				...
				case 'image_max_file_count':
					$optionfield['note']=qa_lang_html_sub('main/max_image_count', '');
					break;					
