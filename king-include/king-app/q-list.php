...
*/
	{
		...
		$navigation=array(
			'by-videos' => array(
				'label' => '<i class="fas fa-video"></i> ' . qa_lang('main/nav_type_video'),
				'url' => qa_path_html($request),
			),

			'by-images' => array(
				'label' => '<i class="fas fa-image"></i> ' . qa_lang('main/nav_type_image'),
				'url' => qa_path_html($request, array('by' => 'images')),
			),

			'by-news' => array(
				'label' => '<i class="fas fa-newspaper"></i> ' . qa_lang('main/nav_type_news'),
				'url' => qa_path_html($request, array('by' => 'news')),
			),
			'by-poll' => array(
				'label' => '<i class="fas fa-align-left"></i> ' . qa_lang('main/nav_type_polls'),
				'url' => qa_path_html($request, array('by' => 'poll')),
			),
			'by-list' => array(
				'label' => '<i class="fas fa-bars"></i> ' . qa_lang('main/nav_type_lists'),
				'url' => qa_path_html($request, array('by' => 'list')),
			),
			'by-trivia' => array(
				'label' => '<i class="fas fa-times"></i> ' . qa_lang('misc/king_trivia'),
				'url' => qa_path_html($request, array('by' => 'trivia')),
			),
			'by-music' => array(
				'label' => '<i class="fas fa-headphones-alt"></i> ' . qa_lang('misc/king_music'),
