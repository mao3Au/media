...
/*
	...
	File: king-include/king-app-favorites.php
...
*/
	...
	{
		require_once QA_INCLUDE_DIR.'king-db/favorites.php';
...
*/
	{
		...
		foreach ($categories as $category) {
			$cat_url = qa_path_html( 'home/' . implode( '/', array_reverse(explode('/', $category['backpath'])) ) );
