...
/*
	...
	File: king-include/king-app/options.php
...
*/
	...
	require_once QA_INCLUDE_DIR.'king-db/options.php';

	define('QA_PERMIT_ALL', 150);
	define('QA_PERMIT_USERS', 120);
	define('QA_PERMIT_CONFIRMED', 110);
	define('QA_PERMIT_VERIFY', 108);
	define('QA_PERMIT_MEMBERSHIP', 107);
...
*/
	...
	/**
	 * @deprecated Deprecated since KINGMEDIA 1.3 now that all options are retrieved together.
	 */
...
/*
	Load all of the KINGMEDIA options from the database, unless QA_OPTIMIZE_DISTANT_DB is set in king-config.php,
...
*/
	{
		...
		$fixed_defaults=array(
			...
			'avatar_q_page_a_size' => 80,
			'avatar_q_page_c_size' => 80,
...
/*
	Return $voteview parameter to pass to qa_post_html_fields() in king-app-format.php for the post in $postorbasetype
