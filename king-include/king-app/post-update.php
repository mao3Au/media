...
/*
	...
	File: king-include/king-app-post-update.php
...
*/
	...
	function qa_question_set_content($oldquestion, $title, $content, $format, $text, $tagstring, $notify, $userid, $handle, $cookieid, $extravalue=null, $name=null, $remoderate=false, $silent=false, $pcontent=null, $nsfw=null)
/*
	...
	modified. Set $silent to true to not mark the question as edited. Reports event as appropriate. See king-app/posts.php
...
*/
	{
		...
		qa_db_post_set_content($oldquestion['postid'], $title, $content, $format, $tagstring, $notify,
			...
			($titlechanged || $contentchanged) ? QA_UPDATE_CONTENT : QA_UPDATE_TAGS, $name, $pcontent, $nsfw);
...
/*
	...
	king-app/posts.php for a higher-level function which is easier to use.
*/
	{
...
/*
	...
	reports. See king-app/posts.php for a higher-level function which is easier to use.
*/
	{
...
/*
	...
	IDs and paths for all answers and comments. See king-app/posts.php for a higher-level function which is easier to use.
*/
	{
...
*/
	{
		require_once QA_INCLUDE_DIR.'king-db/votes.php';
...
/*
	...
	records which are ignored). Handles indexing, user points, cached counts and event reports. See king-app/posts.php for
...
/*
	...
	to true to not mark the question as edited. Handles unindexing and event reports. See king-app/posts.php for a
...
/*
	...
	points, cached counts and event reports. See king-app/posts.php for a higher-level function which is easier to use.
*/
	{
		require_once QA_INCLUDE_DIR.'king-app/format.php';
